...
const Publishform = () => {
  ...
  const generateTags = (e) => {
    ...
    axios
      .post(import.meta.env.VITE_SERVER_DOMAIN + "/generateTag", desObj)
      .then(async (data) => {
  ...
  const publishBlog = (e) => {
    ...
    if (!des.length || des.length > characterLimit) {
      return toast.error(
        `write description about food blog within ${characterLimit} words to publish`
      );
    }
    if (!tags.length) {
      return toast.error("Enter atleast one tag to publish the blog");
    }
  ...
  return (
    <AnimationWrapper>
      <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
        ...
        <div className="border-grey lg:border-1 lg-">
          ...
          <p className="text-dark-grey mb-2 mt-9">
            Short description about your Food blog
          </p>
          <textarea
          ...
          <p className="text-dark-grey mb-2 mt-9">
            Topics - (Helps in searching and ranking your food blog post )
          </p>
          <div className="relative input-box pl-2 py-2 pb-4">
            ...
            <div className="flex items-center gap-3 md:gap-6 ml-auto pt-4">
              <button
                className="bg-white rounded-full px-8"
