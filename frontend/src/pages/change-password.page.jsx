...
const ChangePassword = () =>{
    ...
    const handleSubmit = (e) =>{
        ...
        if(!passwordRegex.test(currentPassword) || !passwordRegex.test(newPassword)){
            ...
            return toast.error("password should be 6 to 20 charcters long with a numeric, 1 lowercase and 1 uppercase letter")
    ...
    return(
        <AnimationWrapper>
            ...
            <form ref={changePasswordForm}>
                <h1 className="max-md:hidden">ChangePassword</h1>
